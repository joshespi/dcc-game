...
var MessageSystem = (function () {
  ...
  MessageSystem.socialAnnouncement = function () {
    var lines = [
      'ATTENTION CRAWLERS. BORANT CORPORATION IS PLEASED TO ANNOUNCE THAT FOLLOWS AND FAVORITES ARE NOW ACTIVE. CRAWLERS WITH SUFFICIENT AUDIENCE ENGAGEMENT WILL RECEIVE PREFERENTIAL LOOT WEIGHTING. PERFORM.',
      'FLOOR 2 SOCIAL METRICS ACTIVATED. YOUR FOLLOWS AND FAVORITES ARE NOW LIVE. VIEWERS ARE WATCHING. BE ENTERTAINING. BORANT DOES NOT COVER FUNERAL EXPENSES FOR BORING CRAWLERS.',
      'DAILY BORANT ANNOUNCEMENT: EFFECTIVE IMMEDIATELY, THE VIEWS, FOLLOWS, AND FAVORITES SYSTEM IS OPERATIONAL. REMAINING CRAWLERS ARE REMINDED THAT AUDIENCE RETENTION AFFECTS LOOT BOX TIER PROBABILITIES.',
    ];
  ...
  // Floor 2 tutorial — Mordecai in Bugaboo form. Same constrained warmth. Different body.
  MessageSystem.tutorialStepFloor2 = function (step) {
    var steps = [
      'MORDECAI: "CRAWLER. I HAVE TAKEN A DIFFERENT FORM. THIS IS NORMAL. DO NOT STARE."',
      'MORDECAI: "FLOOR TWO. DIFFERENT RULES. GOLD DROPS NOW. MOBS HIT HARDER. PAY ATTENTION."',
      'MORDECAI: "YOUR BARS STILL WORK THE SAME. HP. MP. XP. NONE OF THEM SHOULD REACH ZERO."',
      'MORDECAI: "CONTROLS UNCHANGED. THE FLOOR IS CRACKED. WATCH WHERE YOU STEP."',
      'MORDECAI: "GOLD. SPEND IT. DO NOT HOARD IT. YOU WILL NOT GET IT BACK IF YOU DIE."',
      'MORDECAI: "DONUT. SHE IS FINE. THIS FORM UNSETTLES MOST CATS. SHE IS NOT MOST CATS."',
      'MORDECAI: "I AM PLACING THE HEAL ABILITY BACK IN YOUR HOTLIST. YOU ARE WELCOME."',
      'MORDECAI: "TAKE THE SUPPLIES. SAME REASON AS BEFORE. DO NOT READ INTO IT."',
      'MORDECAI: "MENUS AVAILABLE. FIND THE STAIRS. TRY NOT TO MAKE MY JOB HARDER."',
      'SYSTEM: FLOOR TWO ORIENTATION COMPLETE. MORDECAI IS AVAILABLE AS YOUR FLOOR GUIDE.',
    ];
    return steps[step] || '';
  };

  MessageSystem.guildGuide = function (floor) {
    if (floor >= 2) {
      var lines2 = [
        'MORDECAI: "STILL ALIVE. I ADMIT I AM MILDLY SURPRISED."',
        'MORDECAI: "THE GRUBS ARE NOT THE PROBLEM. WHAT THEY BECOME IS THE PROBLEM."',
        'MORDECAI: "DONUT. KEEP HER HEALTHY. THIS STILL APPLIES."',
        'MORDECAI: "YOU ARE DOING BETTER THAN MOST. I AM STILL NOT SUPPOSED TO SAY THAT."',
        'MORDECAI: "DO NOT URINATE OUTSIDE A DESIGNATED RESTROOM. I CANNOT SAY MORE THAN THAT."',
        'MORDECAI: "THE EYES ARE FUNCTIONAL. I CAN SEE FINE. STOP LOOKING AT THEM."',
        'MORDECAI: "GOLD. SPEND IT. I WILL NOT SAY IT AGAIN."',
      ];
      return lines2[Math.floor(Math.random() * lines2.length)];
    }
    var lines = [
